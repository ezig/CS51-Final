...
(deftest gen-children-test
    ...
    (is (= (astar/gen-children p1-tree) '({:puzzle {:rows 3, :cols 3, :tiles [1 2 3 4 5 6 7 8 0]}, 
...
(deftest insert-children-test 
	...
	(let [p1-parent (astar/puzzle-to-tree parent1 0 nil)
		  p2-parent (astar/puzzle-to-tree parent2 0 nil)
		  p3-parent (astar/puzzle-to-tree parent3 0 nil)
		  p4-parent (astar/puzzle-to-tree parent4 0 nil)]
    (let [p1-tree (astar/puzzle-to-tree p1 1 p1-parent)
    	  p2-tree (astar/puzzle-to-tree p2 1 p2-parent)
    	  p3-tree (astar/puzzle-to-tree p3 1 p3-parent)
    	  p4-tree (astar/puzzle-to-tree p4 1 p4-parent)]
    (let [pqueue [p1-tree p2-tree] othertrees [p3-tree p4-tree]]
    (let [inserted-puzzles [p3-tree p1-tree p2-tree p4-tree]
    	  actual (astar/insert-children othertrees pqueue)]
